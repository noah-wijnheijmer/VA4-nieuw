...
if pages == 'Home':
    ...
    st.subheader('Dataset Wereld.')
    st.markdown("Dataset met info per land. ")
    st.dataframe(data=highun, use_container_width=False)
    st.markdown("Dataset met hoogste unemployment.")
    st.dataframe(data=lowun, use_container_width=False)
    st.markdown("Dataset met laagste unemployment.")
